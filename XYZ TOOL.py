...
PU = "\033[2;35m" #purple
print(GG)
print ("""__  ___   _______  _____ ___   ___  _     
\ \/ \ \ / |__  / |_   _/ _ \ / _ \| |    
 \  / \ V /  / /    | || | | | | | | |    
 /  \  | |  / /_    | || |_| | |_| | |___ 
...
slowtype (RR+"termux start has downoload")
if k1 == "2" :  
...
slowtype (RR+"MetaSploit Has download")
if k1== "3":
...
slowtype (RR+"[*] Tool Was install now type (cd) and open tool")
if k1== "4" : 
...
slowtype (RR+"[*] Tool Was install now type (cd) and open tool")
if k1 == "11" : 
    os.system ("pkg update&&pkg upgrade&&pkg install git&&pkg install python&&pkg install python2&&git clone https://github.com/dragon3091/e-sploit&& mv e-sploit $HOME")
slowtype (RR+"[*] Tool Was install now type (cd) and open tool")
if k1 == "12" :
	os.system("pkg update&&pkg upgrade&& pkg install python2&&pkg install python&&pkg install git&& git clone https://github.com/dragon3091/DIOW/&& mv DIOW $HOME")
else : 
    os.system ('exit')
