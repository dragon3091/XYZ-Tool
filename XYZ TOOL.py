...
if k1== "2":
   os.system('pkg update&&pkg upgrade&&pkg install python&&pkg install python2&&pkg install git&&git clone https://github.com/CiKu370/0SIF&&cd OSIF&&chmod +x *&&pip2 install -r requirements.txt&&cd osif.py&&python2 osif.py')
if k1== "3" : 
